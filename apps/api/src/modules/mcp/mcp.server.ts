...
import type { McpServerOptions, McpUseCases } from "./mcp.server.types";
...
import { registerSetPageIconTool } from "./tools/set-page-icon.tool";
...
export type { McpServerOptions, McpUseCases } from "./mcp.server.types";
...
export function createMcpServer(
	...
	registerSetPageIconTool(server, useCases, runTool);
